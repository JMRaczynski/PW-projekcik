        ...
        if (fork() == 0) {
            while (1) {
			    ...
			    printf("ID czerwonych: %d\nID bialych %d\nMOZNA ZACZYNAC GRE\n", redid, whiteid);
                   ...
                   if(msgsnd(msgId, &wiadomosc, 6, 0)<0){
                   ...
                   if(fork()==0){//proces gry
                    ...
                    do{
                        ...
                        if(err==0){
                            ...
                            wiadomosc.type=whiteid;
                            if(msgsnd(msgId,&wiadomosc,1500+2*sizeof(int),0)<0){
                            ...
                            if(msgsnd(msgId,&wiadomosc,100+2*sizeof(int),0)<0){
                        ...
                        if(msgrcv(msgId,&odbior,20,odbior.type,0)<0){
